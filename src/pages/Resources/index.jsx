...
class Resource extends React.Component {
  constructor() {
    ...
    this.state = {
      contentList: [
        {name: '1', url: 'http://sgis.site/resource/1'},
        {name: '2', url: 'http://sgis.site/resource/2'},
        {name: '3', url: 'http://sgis.site/resource/2'},
        {name: '4', url: 'http://sgis.site/resource/2'},
        {name: '5', url: 'http://sgis.site/resource/2'},
        {name: '6', url: 'http://sgis.site/resource/2'},
        {name: '7', url: 'http://sgis.site/resource/2'},
        {name: '8', url: 'http://sgis.site/resource/2'},
        {name: '9', url: 'http://sgis.site/resource/2'}
      ],
      listDom: []
    };
